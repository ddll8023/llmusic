...
from app.common.configure_logging import configure_logging
...
from app.services.search_song import get_song_url_list, search_songlist
    ...
    try:
        ...
        if url_type == "song":
            ...
            if response.status_code == 302:
                ...
                from app.services.search_song import search_song
